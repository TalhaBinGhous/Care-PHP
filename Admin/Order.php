...
<div class="site-wrap">
    ...
    <a href="order-item.php">
    <input type="submit" class="btn btn-primary" value="Order Items">
    </a>
    </div></div>
      ...
      <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <th class="text-black">User Id</th>
              <th class="text-black"> User Order Name</th>
              <th class="text-black">User Order Phone</th>
              <th class="text-black">User Order Address</th>
              <th class="text-black">User Order Email</th>
              
              <th class="text-black">User Order Date</th>
            ...
            ?>
                <tr>
                    ...
                    <td class="product"><?php echo $row["uid"]; ?></td>
                    ...
                    <td><a href="deleteO.php?id=<?php echo $row['oid']; ?>" class="btn btn-danger">Delete</a></td>
                </tr>
            <?php } ?>
        </table>
