...
if (isset($_GET["id"]) && is_numeric($_GET["id"])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: products.php?message=Item deleted successfully");
    } else {
        // Optionally, you can redirect with an error message
        header("Location: products.php?error=Could not delete item");
    }
    ...
    header("Location: products.php?error=Invalid item ID");
}
?>
