...
<body>
    ...
    <h3 class="text-black">View Doctors</h3>
    ...
    <?php
    $sql = "SELECT *
    FROM drproducts INNER JOIN drcategories
    ON drproducts.dr_cat_id = drcategories.dr_id;";
      ...
      <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <th class="text-black">#</th>
              <th class="text-black">Doctor Name</th>
              <th class="text-black">About</th>
              <th class="text-black">Doctor Category</th>
              <th class="text-black">Doctor Image</th>
            ...
            ?>
                <tr>
                    <td class="product"><?php echo $row["dr_pid"]; ?></td>
                    <td><?php echo $row["dr_name"]; ?></td>
                    <td><?php echo $row["msj"]; ?></td>
                    <td><?php echo $row["dr_Categories"]; ?></td>
                    <td >
                        <img src="<?php echo "images/".$row["dr_img"] ?>" alt="" width="200px" height="200px">
                    </td>
                    <td><a href="deleteD.php?id=<?php echo $row['dr_pid']; ?>" class="btn btn-danger">Delete</a></td>
                </tr>
            <?php } ?>
        </table>
