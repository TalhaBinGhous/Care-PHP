...
<div class="site-section bg-light">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-2 m-2"></div></div></div>
        <!-- Hero End -->
        <!--================Blog Area =================-->
		...
		<section class="ftco-section bg-light">
          ...
          <div class="col-md-4 ftco-animate">
            ...
            <img src="images/image_1.jpg" height="300px" width="50px" class="card-img-top" alt="...">
              ...
              <div class="text bg-white p-4">
                ...
                <div class="d-flex align-items-center mt-4">
	                ...
	                <p class="mb-0" style="color: greenyellow;"><a href="#" class="btn btn-primary " >Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
            <img src="images/image_2.jpg" height="300px" width="50px" class="card-img-top" alt="...">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
            <img src="images/image_3.jpg" height="300px" width="50px" class="card-img-top" alt="...">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
            <img src="images/image_4.jpg" height="300px" width="50px" class="card-img-top" alt="...">
              <div class="text bg-white p-4">
                <h3 class="heading"><a href="#">Scary Thing That You Don’t Get Enough Sleep</a></h3>
                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                <div class="d-flex align-items-center mt-4">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
            <img src="images/image_5.jpg" height="300px" width="50px" class="card-img-top" alt="...">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
            <img src="images/image_6.jpg" height="300px" width="50px" class="card-img-top" alt="...">
