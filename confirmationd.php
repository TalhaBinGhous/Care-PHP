      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="lead mb-5">You Appointment was successfuly completed.</p>
            <p><a href="doctord.php" class="btn btn-md height-auto px-4 py-3 btn-primary">Back to Doctor</a></p>
          </div>
        </div>
      </div>
    </div>
