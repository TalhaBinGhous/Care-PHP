...
if (isset($_GET["id"]) && is_numeric($_GET["id"])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: cartd.php?message=Item deleted successfully");
    } else {
        // Optionally, you can redirect with an error message
        header("Location: cartd.php?error=Could not delete item");
    }
    ...
    header("Location: cartd.php?error=Invalid item ID");
}
?>
