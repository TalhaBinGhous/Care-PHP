      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="lead mb-5">You Registration was successfuly completed.</p>
            <p><a href="index.php" class="btn btn-md height-auto px-4 py-3 btn-primary">Back to Home Page</a></p>
          </div>
        </div>
      </div>
    </div>
